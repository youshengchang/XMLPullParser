...
public class ToursPullParser {
	...
	private com.exploreca.tourfinder.model.Tour currentTour  = null;
	private String currentTag = null;
	List<com.exploreca.tourfinder.model.Tour> tours = new ArrayList<com.exploreca.tourfinder.model.Tour>();

	public List<com.exploreca.tourfinder.model.Tour> parseXML(Context context) {
	...
	private void handleStartTag(String name) {
		if (name.equals("tour")) {
			currentTour = new com.exploreca.tourfinder.model.Tour();
